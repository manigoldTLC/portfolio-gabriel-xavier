...
export default function Projects() {
  ...
  const projects = [
    ...
    {
      id: 2,
      title: 'PriceWise - Comparador de Preços com IA',
      description: 'Plataforma SaaS de monitoramento de preços que utiliza Inteligência Artificial (Gemini) para analisar o melhor momento de compra. Conta com sistema de alertas em tempo real, histórico de preços interativo, filtros dinâmicos e persistência de dados, focada em alta performance e UX.',
      tags: ['React', 'TypeScript', 'Vite', 'Redux Toolkit', 'Tailwind CSS', 'Shadcn UI', 'Gemini AI', 'Recharts'],
      link: 'https://price-wise-dusky.vercel.app/',
      featured: true,
